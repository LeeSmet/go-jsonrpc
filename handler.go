...
import (
	...
	"github.com/LeeSmet/go-jsonrpc/metrics"
)
...
func (s *handler) handleReader(ctx context.Context, state State, r io.Reader, w io.Writer, rpcError rpcErrFunc) {
...
func (s *handler) handle(ctx context.Context, state State, req request, w func(func(io.Writer)), rpcError rpcErrFunc, done func(keepCtx bool), chOut chanOut) {
